...
def selectTYUserKeep():
    """ 月份	"新增用户数"	"1个月后下单用户数"	其中：之前下过1单的用户数	其中：之前下过2单的用户数	其中：之前下过3单的用户数	其中：之前下过4单的用户数	其中：之前下过5单的用户数	其中：之前下过6单的用户数	其中：之前下过7单的用户数	其中：之前下过8单的用户数	其中：之前下过9单的用户数	其中：之前下过10单的用户数	其中：之前下过＞10单的用户数
"""
    daystr = '2019-01-01'
